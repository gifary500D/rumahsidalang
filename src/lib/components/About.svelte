		...
		<div class="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-12">
			...
			<div class="slide-up order-1 space-y-6 md:order-2">
				...
				<p class="leading-relaxed text-gray-700 dark:text-gray-300">
					<strong>Rumah Si Dalang</strong> lahir dari kecintaan terhadap kopi dan budaya Indonesia. Seperti
					seorang dalang yang menceritakan kisah melalui wayang, kami menceritakan kisah melalui setiap
					cangkir kopi yang kami sajikan.
				</p>

				<p class="leading-relaxed text-gray-700 dark:text-gray-300">
					Setiap biji kopi kami pilih dengan cermat dari petani lokal terbaik. Kami percaya bahwa
					kopi bukan sekadar minuman, tetapi sebuah pengalaman yang menyatukan orang-orang dalam
